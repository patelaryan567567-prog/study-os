...
import { cn, statusToneClass } from "@/utils";
...
export function LectureTracker() {
  ...
  return (
    <ModuleShell
      ...
      subtitle="Track your lectures, chapters, and progress."
      headerClassName="lg:flex-row lg:items-center lg:justify-between"
      actions={
                ...
                {chapter.lectures.map((lecture) => (
                  ...
                  >
                    <div
                      className={cn(
                        "rounded-full p-1",
                        statusToneClass(lecture.status),
                      )}
                    >
