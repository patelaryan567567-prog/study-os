...
import { ProtectedRoute, PublicOnlyRoute, AuthRedirectHandler } from "./AuthRouteGuards";
...
const AppBlockerPage = lazy(() =>
  import("@/modules/blocker/AppBlocker").then((m) => ({ default: m.AppBlocker })),
);
...
export function AppRoutes() {
  return (
    <Suspense fallback={<div />}>
      <Routes>
        {/* Firebase redirect callback (desktop Google sign-in returns here). */}
        <Route path="/__/auth/*" element={<AuthRedirectHandler />} />
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<AppLayout />}>
            ...
            <Route path={ROUTE_PATHS.blocker} element={<AppBlockerPage />} />
